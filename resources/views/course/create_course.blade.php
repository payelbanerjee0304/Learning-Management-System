    ...
    <div class="d_brd_otr new">
        ...
        <form action="javascript:void(0)" method="POST" id="dynamic-form" enctype="multipart/form-data">
            ...
            <div class="tsk_otr">
                ...
                <small id="" class="error notifyMsg" style="color: #990000"><strong>To embark on adding a new chapter, just click 'Submit & Continue'!</strong></small>
            </div>
...
<script>
    ...
    //         editorInstances[$(this).attr('id')] = editor;
    //         console.log(editorInstances[$(this).attr('id')]);
    //     })
    //     .catch(error => {
    //         console.error('There was a problem initializing the editor.', error);
    //     });
// $(".create_editor").each(function (index, element) {
//     // Create CKEditor instance for each textarea found
//     if (index > 1) {
//     // Create CKEditor instance for each textarea found, except the first one
//     ClassicEditor.create(element)
//       .then((editor) => {
//         var editorId = $(element).attr("id");
//         editorInstances[editorId] = editor; // Store instance with unique key
//         console.log("Initialized CKEditor for", editorId);
//       })
//       .catch((error) => {
//         console.error("Error initializing CKEditor for existing content:", error);
//       });
//   }
//   });
